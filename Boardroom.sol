...
contract Boardroom is ContractGuard {
    ...
    function getMokaPrice() external view returns (uint256) {
        return treasury.getMokaPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            moka.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        moka.safeTransferFrom(msg.sender, address(this), amount);
