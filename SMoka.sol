...
contract SMoka is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 sMOKAs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SMOKA", "SMOKA") {
        _mint(msg.sender, 10 ether); // mint 10 SMOKA Share for initial pools deployment
